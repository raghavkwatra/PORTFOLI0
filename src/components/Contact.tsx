...
const Contact = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const mailtoLink = `mailto:rkwatra454@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <p className="text-muted-foreground mb-8 leading-relaxed">
                ...
                Whether you have a question about my work, want to discuss a potential opportunity, 
